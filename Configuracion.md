...
9.1 Actualizar las listas de paquetes e instalar las actualizaciones disponibles
...
9.2 Instalar los requisitos previos del PPA
...
9.3. Agregar el PPA para PHP (Ondřej Surý's PHP PPA)
...
9.4 Actualizar los repositorios
...
9.5 Instalar PHP 7.4 y las extensiones necesarias
...
9.6 Seleccionar la versión de PHP por defecto
...
9.7 Activar los módulos de Apache necesarios para PHP 7.4
